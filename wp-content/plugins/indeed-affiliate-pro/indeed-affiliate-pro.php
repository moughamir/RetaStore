<?php
/*
Plugin Name: Indeed Ultimate Affiliate Pro - shared on NulledNerd.com
...
class UAP_Main{
	...
	public static function run(){
		...
		if (!defined('UAP_PLUGIN_VER')){			
			define('UAP_PLUGIN_VER', 1.9);//used for updates
		}

		update_option('uap_license_set', 1);
        update_option('uap_envato_code', '2b35dec6-5674-314f-5d8d-9fe900dc03b8');
