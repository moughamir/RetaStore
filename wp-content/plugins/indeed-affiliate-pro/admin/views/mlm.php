					...
					<div class="row">
						...
						<div class="row">
							<div class="col-xs-5">
								...
								<div class="input-group" id="children_limit_div">
						...
						<div class="row">
							<div class="col-xs-5">
								...
								<p><?php _e('Set the default Amount that will be used when no special amount is set for certain Rank.', 'uap');?></p>
						...
						<div class="row">
							...
							<p><?php _e('Set a special MLM Amount for each Level for all your Ranks. This option will become available into Rank Settings page also providing the option to set special Amount for each Level on each Rank.', 'uap');?></p>
