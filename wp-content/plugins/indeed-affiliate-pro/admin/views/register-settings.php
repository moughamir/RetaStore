...
<form action="" method="post">
	<div class="uap-stuffbox">
		...
		<div class="inside">
			<div class="uap-register-select-template">
				<?php 
					$templates = array('uap-register-1'=>__('Template', 'uap').' 1', 'uap-register-2'=>__('Template', 'uap').' 2', 'uap-register-3'=>__('Template', 'uap').' 3',
										'uap-register-4'=>__('Template', 'uap').' 4', 'uap-register-5'=>__('Template', 'uap').' 5', 'uap-register-6'=>__('Template', 'uap').' 6', 'uap-register-7'=>__('Template', 'uap').' 7');
				?>
	...
	<div class="uap-stuffbox">
		...
		<div class="inside">
			<div class="uap-form-line">
				...
				<div class="uap-form-line" id="rank_assign_to_user" style="padding:0;border-bottom: none; margin-top:10px;" >
					<div style="font-weight:bold"><?php _e('Default Rank assign to new user', 'uap');?></div>
		...
		<div class="uap-form-line">						
			...
			<p><?php _e('If the "Pending" Role is set, the user can not login until the Admin manually Approve the user.', 'uap');?></p>													
		</div>
