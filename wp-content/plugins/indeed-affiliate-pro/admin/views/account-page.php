	...
	<div class="uap-stuffbox">
		<h3 class="uap-h3"><?php _e('Top Section:', 'uap');?></h3>
			...
			<div class="inside">
				...
				<p><?php _e('The Cover or Background Image, based on what Theme have you chosen', 'uap');?></p>
				<div class="input-group">	
				<label class="uap_label_shiwtch uap-onbutton">
				...
				<div class="form-group" style="margin:20px 0 10px 10px">
					<input type="text" class="form-control" onClick="open_media_up(this);" value="<?php  echo $data['metas']['uap_ap_edit_background_image'];?>" name="image" id="uap_ap_edit_background_image" style="width: 90%;display: inline; float:none; min-width:500px;"/>
