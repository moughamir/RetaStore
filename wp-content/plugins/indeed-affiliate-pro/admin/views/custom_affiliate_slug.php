	...
	<div class="uap-stuffbox">
		...
		<div class="inside">
			...
			<div class="row" style="margin-top: 30px;">
				<div class="col-xs-8">
					<p><?php _e('Establish conditional requirements when Affiliate want to set his personal Custom Slug. Be sure that there are no chances that another Affiliate that will register later it will not set a username similar with a saved Custom Slug.', 'uap');?></p>
				</div>
			</div>	
