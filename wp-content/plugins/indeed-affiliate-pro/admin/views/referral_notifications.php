		...
		<div class="inside">
			...
			<div class="row">
				<div class="col-xs-7">
					...
					<p><?php _e('Based on this Module, the affiliates have the option to Receive Instantly notofications when he got a new Referral. Also, the Affiliate can decides from Account Page which type of Refferal will be noticed via Email', 'uap');?></p>
