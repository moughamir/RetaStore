				...
				<div class="uap-inside-item">		
					...
					<div class="row">
						...
						<h4><?php _e('Activate/Hold Coupon', 'uap');?></h4>
							<p><?php _e('You can activate or deactivate a Coupon anytime without delete it.', 'uap');?></p>
					...
					<div class="uap-inside-item">
						<div class="row">	
							<div class="col-xs-4">
								...
								<p><?php _e('A special Amount for this specific Coupon needs to be set which will take in place the standard Amount Rank', 'uap');?></p>	
