	...
	<div class="uap-page-title">Ultimate Affiliate Pro - <span class="second-text"><?php _e('Landing Commissions', 'uap');?></span></div>
		...
		<?php if (!empty($data['listing_items'])) : ?>
			<form action="" method="post" id="form_shortcodes">
				...
				<div class="uap-info-box"><?php _e('Just copy the Landing Commission shortcode into any Successful Page (ex: Thank You Register page) and the Affiliate will receive a certain commission for that based on generated Referral.', 'uap');?></div>
					      ...
					      <div class="uap-admin-dashboard-offer-box" id="uap-b-item-1" style="background-color: <?php echo $color;?>">
					         ...
					         <div class="uap-admin-dashboard-offer-box-bottom">
					            <div class="uap-admin-dashboard-offer-box-files">
									<?php echo $inside_data['amount_value'] . $currency;?>
