											...
											switch ($inside_array['type']):											
												...
												case 'stripe':
													...
													if ($inside_array['is_active'] && !empty($inside_array['settings']) && !empty($inside_array['settings']['uap_affiliate_stripe_name'])
														&& !empty($inside_array['settings']['uap_affiliate_stripe_card_number']) && !empty($inside_array['settings']['uap_affiliate_stripe_cvc'])
														&& !empty($inside_array['settings']['uap_affiliate_stripe_expiration_month']) && !empty($inside_array['settings']['uap_affiliate_stripe_expiration_year']) )
													{
