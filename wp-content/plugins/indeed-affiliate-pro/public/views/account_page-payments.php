...
<div class="uap-row">
		<div class="uapcol-md-2">
			<div class="uap-account-no-box"><div class="uap-account-no-box-inside"><div class="uap-count"><?php echo $data['stats']['paid_payments_value'] .  ' ' . $data['currency'];?></div><div class="uap-detail"><?php _e('Total Transactions Amount', 'uap');?></div></div></div>
		</div>	
		<div class="uapcol-md-2">
