...
<div class="uap-row">
	<div class="uapcol-md-2">
			<div class="uap-account-no-box uap-account-box-green">
			 <div class="uap-account-no-box-inside">
			  	<div class="uap-count"> <?php echo round($data['stats']['paid_payments_value'], 2) .' '. $data['stats']['currency']; ?> </div>
		...
		<div class="uapcol-md-2">
			<div class="uap-account-no-box uap-account-box-red">
			 <div class="uap-account-no-box-inside">
			  	<div class="uap-count"> <?php echo round($data['stats']['unpaid_payments_value'], 2) .' '. $data['stats']['currency']; ?> </div>
	...
	<!--div class="uap-public-general-stats">
		...
		<div><?php echo __('Total value of Paid Payments:') . round($data['stats']['paid_payments_value'], 2) . $data['stats']['currency'];?></div>
		<div><?php echo __('Total value of Unpaid Payments:') . round($data['stats']['unpaid_payments_value'], 2) . $data['stats']['currency'];?></div>	
	</div-->
<?php endif;?>
